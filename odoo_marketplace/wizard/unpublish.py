...
class UnpublishActionDetails(models.TransientModel):
    ...
    def unpublish_all_products(self):
        if self.product_ids:
            ...
            msg = "<p style='font-size: 15px'>Selected product(s) can't be unpublish, only approved product(s) will get unpublish.<p>"
            ...
            if approved_products:
                ...
                msg = "<p style='font-size: 15px'>Product(s) unpublished successfully: <strong>" + p_list + "</strong></p>"
