...
import {  } from "@web/core/l10n/translation";
...
// var  = core.;
    $(document).ready(function() {
        ...
        $('#btn-create-review').on('click',function (e){
            ...
            {
                $("#submit-msg").empty();
                $("#submit-msg").html((" Please add your rating !!!"));
            ...
            else if(title == "")
            {
                ...
                $("#submit-msg").html((" Review title is required field."));
                $("#submit-msg").addClass("alert-danger submit-error-msg fa fa-exclamation-triangle");
                $('#submit-msg').show();
            }
            else if(review_summary == "")
            {
                ...
                $("#submit-msg").html((" Review is required field."));
