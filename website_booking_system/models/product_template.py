...
class SaleOrder(models.Model):
    ...
    def _cart_find_product_line(self, product_id, line_id=None, **kwargs):
        line_obj = super(SaleOrder, self)._cart_find_product_line(product_id, line_id=None, **kwargs)
...
class ProductTemplate(models.Model):
    ...
    max_bk_qty = fields.Integer("Max Booking Qty",default="5")
    ...
    def create(self, vals):
        for value in vals:
            self.validate_booking_dates(value.get("br_start_date"), value.get("br_end_date"))
