...
class RentalOrderWizard(models.TransientModel):
    ...
    def product_id_change(self):
        ...
        if self.product_id:
            ...
            self.unit_security_amount = self.product_id.currency_id._convert(
    ...
    def action_add_rental_product(self):
        ...
        if self.product_id:
            ...
            sol_values = {
                ...
                'price_unit': self.product_id.currency_id._convert(price_unit, self.order_id.pricelist_id.currency_id),
                'product_uom': 1, #unit
                ...
                # 'rental_status': "new",
                'unit_security_amount': self.product_id.currency_id._convert(self.unit_security_amount or self.product_id.security_amount, self.order_id.pricelist_id.currency_id),
            }
